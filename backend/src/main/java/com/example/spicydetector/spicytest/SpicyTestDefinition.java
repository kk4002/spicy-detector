...
public final class SpicyTestDefinition {
    ...
    public static final List<Question> QUESTIONS = Arrays.asList(
            ...
            new Question("HACK_BULDAK", "핵불닭볶음면은 어떤가요?",
                    new Option("NO", "못 먹는다", 0),
                    new Option("TRY", "도전은 해본다", 20),
                    new Option("OK", "어느 정도 가능", 50),
                    new Option("EASY", "즐길 수 있다", 80)),

            new Question("TTEOKBOKKI", "매운 떡볶이는 어느 정도까지 가능한가요?",
                    new Option("MILD", "순한맛", 0),
                    new Option("NORMAL", "보통맛", 14),
                    new Option("HOT", "매운맛", 28),
                    new Option("EXTREME", "아주 매운맛", 40))
    );

    /** 등급 구간 (총점 0~220 기준). tolerance* 는 신라면=100 환산 예상 맵력. */
    public static final List<SpicyGrade> GRADES = Arrays.asList(
            new SpicyGrade(1, "LV1", "순한맛 시민", 0, 30, 40, 90,
                    "순한 음식", "신라면", "열라면 이상",
                    Arrays.asList("진라면 순한맛", "국물 떡볶이 순한맛"),
                    Arrays.asList("불닭볶음면", "핵불닭볶음면")),
            new SpicyGrade(2, "LV2", "신라면 생존자", 31, 60, 90, 110,
                    "신라면", "열라면", "불닭볶음면 이상",
                    Arrays.asList("신라면", "진라면 매운맛"),
                    Arrays.asList("핵불닭볶음면", "디진다돈가스급")),
            new SpicyGrade(3, "LV3", "열라면 통과자", 61, 95, 110, 140,
                    "신라면 ~ 열라면", "불닭볶음면", "핵불닭 이상",
                    Arrays.asList("열라면", "신라면 더레드"),
                    Arrays.asList("핵불닭볶음면", "디진다돈가스급")),
            new SpicyGrade(4, "LV4", "불닭 도전자", 96, 130, 140, 180,
                    "신라면 ~ 열라면", "불닭볶음면", "핵불닭 이상",
                    Arrays.asList("불닭볶음면", "엽기떡볶이 매운맛"),
                    Arrays.asList("핵불닭볶음면", "틈새라면")),
            new SpicyGrade(5, "LV5", "불닭 생존자", 131, 165, 180, 230,
                    "신라면 ~ 불닭볶음면", "핵불닭볶음면", "디진다돈가스급 이상",
                    Arrays.asList("불닭볶음면", "틈새라면"),
                    Arrays.asList("핵불닭볶음면")),
            new SpicyGrade(6, "LV6", "핵불닭 생존자", 166, 195, 230, 300,
                    "불닭볶음면까지 무난", "핵불닭볶음면", "캡사이신 원액급",
                    Arrays.asList("핵불닭볶음면", "틈새라면"),
                    Arrays.asList("순수 캡사이신 소스")),
            new SpicyGrade(7, "LV7", "캡사이신 전사", 196, 220, 300, 400,
                    "핵불닭볶음면까지 즐김", "디진다돈가스급", "몸 상하는 구간",
                    Arrays.asList("핵불닭볶음면", "하바네로 소스"),
